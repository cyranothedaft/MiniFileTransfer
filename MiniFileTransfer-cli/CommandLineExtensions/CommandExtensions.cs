...
public static class CommandExtensions {
   ...
   public static TCommand WithHandler<TCommand, V1, V2, V3, V4, V5>(this TCommand command, Func<V1, V2, V3, V4, V5, Task> handler, IValueDescriptor<V1> value1, IValueDescriptor<V2> value2, IValueDescriptor<V3> value3, IValueDescriptor<V4> value4, IValueDescriptor<V5> value5) where TCommand : Command => command.DoAndReturn(c => { c.SetHandler(handler, value1, value2, value3, value4, value5); });
