...
internal class SocketServer : IServer {
   ...
   public async Task RunAsync(int listenOnPort, bool isReceiving
      ...
      if (isReceiving) {
         await FileReadWrite.ReceiveFile(networkStream, "===.receiveFileName", _logger);
      }
   }
